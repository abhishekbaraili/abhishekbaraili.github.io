...
![Figure 1. Primary or secondary use of remittances across 3,593 remittance-receiving households. Households may report up to two uses, so bars sum to more than 100%. Source: author's calculations from NLSS IV (2022/23).](images/fig1_remit_use.png)
...
winsor2 debt_burden, cuts(0 99) suffix(_w)   // trim top 1% of the ratio
```
...
![Figure 2. Mean migration debt as share of per capita expenditure by broad caste group. Remittance-receiving households, weighted means, debt burden winsorised at the 99th percentile. Source: author's calculations from NLSS IV (2022/23).](images/fig2_debt_caste.png)
...
Dalit households carry a mean migration debt burden of 0.576, which is 71% higher than Janajati households (0.337) and 46% higher than Brahmin-Chhetri households (0.394). And when I estimated the debt-education relationship separately by caste group, the coefficients diverged sharply.
